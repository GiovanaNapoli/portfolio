          ...
          >
            <div className="flex flex-col gap-5">
              ...
              <p className="dark:text-white">
                ...
                pleno, me especializei em React, React Native, Angular,
                JavaScript e TypeScript para criar experiências digitais que
                deixam os usuários com um sorriso no rosto.
              </p>
